...
We collect the contact details, date of birth, occupation, lifestyle and health information, treatment goals, emergency-contact details, consent declarations and signature you provide. We also keep relevant consultation and treatment records. We use this information to arrange appointments, assess treatment suitability, adapt treatment and maintain a record of your care. Please make sure your emergency contact knows you have supplied their details; we use them only when needed in an emergency.

### Our legal bases

We use information necessary to arrange and deliver your requested services under Article 6(1)(b) of the UK GDPR. We rely on your explicit consent under Article 9(2)(a) to use health information for assessment and treatment. Our legitimate interests under Article 6(1)(f) include maintaining appropriate records and dealing with complaints or legal claims; health information is retained or used for legal claims only where Article 9(2)(f) applies. A legal obligation may also require particular information to be retained or disclosed. We do not use this consultation form to enrol you in marketing.
...
Our normal retention period is eight years after your last treatment. If you complete a consultation but do not receive treatment, we count from your last consultation. A specific legal obligation or ongoing claim may require longer retention. Records are then securely deleted, including copies under our control, subject to the providers' backup-deletion cycles.
...
Treatment decisions are made by your therapist, not solely by an automated system. Please read this notice before completing the form. You can request a copy by email.
...
The website has no contact form and does not create customer accounts. If you follow an email or phone link, you decide what information to share. Jenergie uses enquiry information to reply, discuss services, arrange appointments, maintain appropriate records and meet legal obligations.
